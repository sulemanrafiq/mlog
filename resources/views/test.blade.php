...
{{--    <link href="{{ asset('js/custome.js') }}" rel="stylesheet">--}}
{{--    <link href="{{ asset('js/boots.js') }}" rel="stylesheet">--}}
{{--    <link href="{{ asset('js/boot.js') }}" rel="stylesheet">--}}
    <script src="{{ asset('js/boot.js') }}" defer></script>
    <script src="{{ asset('js/boots.js') }}" defer></script>
